                    ...
                    <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                        <div class="col-xxl-3">
                            ...
                            <div class="card h-150px bgi-no-repeat bgi-size-cover card-xxl-stretch"
                                style="background-image:url('assets/media/stock/600x400/img-75.jpg')">
                                <!--begin::Body-->
                                <div class="card-body">
                                    <!--begin::Title-->
                                    <a href="#" class="text-gray-800 text-hover-primary fw-bolder fs-2"
                                        data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Properties</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Body-->
                            </div>
                            ...
                            <div class="card h-150px card-xxl-stretch">
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                                    <div class="me-2">
                                        ...
                                        <div class="text-muted fw-bold fs-6">Generate the latest CRM report
                                            for company projects</div>
                                    </div>
                                    <a href="#" class="btn btn-primary fw-bold" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_create_app">Start Now</a>
                                </div>
                                <!--end::Body-->
                            </div>
                            <!--end::Tiles Widget 4-->
                    ...
                    <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                        ...
                        <div class="col-xxl-6">
                            ...
                            <div class="card h-175px bgi-no-repeat bgi-size-cover card-xxl-stretch mb-5 mb-xl-8"
                                style="background-color: #663259; background-position: calc(100% + 0.5rem) 100%;background-size: 100% auto;background-image:url('assets/media/svg/misc/taieri.svg')">
                                <!--begin::Body-->
                                <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <div class="m-0">
                                        <a href='#' class="btn btn-success fw-bold px-6 py-3" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_create_app">Create Report</a>
                                    </div>
                                    <!--begin::Action-->
                                </div>
                                <!--end::Body-->
                                ...
                                <div class="col-xxl-6">
                                    ...
                                    <a href="#" class="card bg-primary card-xxl-stretch">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!--end::Svg Icon-->
                                            <div class="text-inverse-primary fw-bolder fs-1 mb-2 mt-5">790
                                            </div>
                                            <div class="fw-bold text-inverse-primary fs-6">New Products
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                    </a>
                                ...
                                <div class="col-xxl-6">
                                    ...
                                    <a href="#" class="card bg-bg-body card-xxl-stretch">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!--end::Svg Icon-->
                                            <div class="text-inverse-bg-body fw-bolder fs-1 mb-2 mt-5">8,600
                                            </div>
                                            <div class="fw-bold text-inverse-bg-body fs-6">New Customers
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                    </a>
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" data-kt-select2="true"
                                                    ...
                                                    data-dropdown-parent="#kt_menu_61233bb4d9552"
